...
public class ModItemGroups {
	...
	public static final ItemGroup ITEMS_GROUP = Registry.register(
		...
		FabricItemGroup.builder()
		    ...
		    .displayName(Text.translatable("itemgroup.rainbowgear.items"))
    ...
    public static final ItemGroup BLOCKS_GROUP = Registry.register(
	    ...
	    FabricItemGroup.builder()
				...
				.displayName(Text.translatable("itemgroup.rainbowgear.blocks"))
				.entries((displayContext, entries) -> {
	...
	public static void register() {
		RainbowGear.LOGGER.info("Registering Item Groups for " + ModInformation.Id);
	}
